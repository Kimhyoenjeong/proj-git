            ...
            <div class="container">
            	<div class="content2-month">
					...
					<div class="search-frame-month">
							<div class="month">
							<a><span class="ir_pm">월&nbsp;</span></a>
							<div class="select">
								<form name="thisMonth" onchange="mainMove();">
										<option type="checkbox" value="01" <%=thisMonth.equals("01")?"selected":""%>><label for="cb1"></label>1월</option>
										<option type="checkbox" value="02" <%=thisMonth.equals("02")?"selected":""%>><label for="cb1"></label>2월</option>
										<option type="checkbox" value="03" <%=thisMonth.equals("03")?"selected":""%>><label for="cb1"></label>3월</option>
										<option type="checkbox" value="04" <%=thisMonth.equals("04")?"selected":""%>><label for="cb1"></label>4월</option>
										<option type="checkbox" value="05" <%=thisMonth.equals("05")?"selected":""%>><label for="cb1"></label>5월</option>
										<option type="checkbox" value="06" <%=thisMonth.equals("06")?"selected":""%>><label for="cb1"></label>6월</option>
										<option type="checkbox" value="07" <%=thisMonth.equals("07")?"selected":""%>><label for="cb1"></label>7월</option>
										<option type="checkbox" value="08" <%=thisMonth.equals("08")?"selected":""%>><label for="cb1"></label>8월</option>
										<option type="checkbox" value="09" <%=thisMonth.equals("09")?"selected":""%>><label for="cb1"></label>9월</option>
										<option type="checkbox" value="10" <%=thisMonth.equals("10")?"selected":""%>><label for="cb1"></label>10월</option>
										<option type="checkbox" value="11" <%=thisMonth.equals("11")?"selected":""%>><label for="cb1"></label>11월</option>
										<option type="checkbox" value="12" <%=thisMonth.equals("12")?"selected":""%>><label for="cb1"></label>12월</option>						
								</form>
							</div>
							</div>
					</div>	
